...
export default function App(props) {
  ...
  if (!isLoadingComplete && !props.skipLoadingScreen) {
    ...
    <Ionicons color="white" size={40} style={{marginLeft: 10, marginTop: 5}} name="md-menu" />
    </TouchableOpacity>
      )
    } }} />
            <Stack.Screen name="Category" component={CategoryApi}  options={{ headerTintColor: "red", title: categoryTitle }}  />
